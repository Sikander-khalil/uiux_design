...
// SizedBox(width: 340,),
                          ...
                          Container(
                            ...
                            child: Text('What is your mind ? #Hashing.\n @Mention.. Link')
                          ),
                        ],
                      )),
      ...
      child: Column(
        ...
        children: [
          Container(
            ...
            child:  Text('Welcome Atif ',style: TextStyle(fontWeight: FontWeight.bold),),

          ),
           Container(
margin: EdgeInsets.only(top: 20),

             child: Text('Write it on your heart that every day is the \n best day in the year'))
        ],
                   ...
                   children: [
                     Padding(
                       ...
                       child: Container(
                           ...
                           child: Text('Recent Update',style: TextStyle(fontSize: 20,fontWeight: FontWeight.bold),)),
                     ),
                     Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          Container(
                            ...
                            child:  Text('kritkia Sharma ',style: TextStyle(fontWeight: FontWeight.bold,color: Colors.blue),),
      ...
      drawer: Drawer(
        ...
        child: ListView(
          ...
          children: [
            ...
            ListTile(
              leading: CircleAvatar( radius: 15.0,),
                          ...
                          SingleChildScrollView(
                            ...
                            child: Row(
                              children: [
                                ...
                                Container(
                                    margin: EdgeInsets.only(right: 70,top: 0),
                                    child: IconButton(icon: Icon(Icons.keyboard,color: Colors.black,), onPressed: () {  },)),
                              ...
                              children: [
                                Padding(
                                  ...
                                  child: Container(
                                      ...
                                      margin: EdgeInsets.only(top: 0,right: 102),
                                      child: Text('Night Mode',)),
                                ),

                                Container(
                                    margin: EdgeInsets.only(right: 70,top: 0),
                                    child: IconButton(icon: Icon(Icons.mode_night,color: Colors.black,), onPressed: () {  },)),
